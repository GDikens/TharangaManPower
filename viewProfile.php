...
<?php
	...
	if(isset(_POST['insert'])){
		...
		$get=mysqli_query($mydb,"select * from employee where EmployeeID='$id'");
...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Tharanga Man Power &raquo; Employee Profile</h2>
			<hr />
			...
			<form class="form-horizontal" action="" method="POST">
				<div class="form-group">
					...
					<div class="col-sm-2">
						...
						<button type="submit" name="" class="btn btn-sm btn-primary" value="Submit">Search</button>
					</div>
				</div>
				<div class="form-group">
